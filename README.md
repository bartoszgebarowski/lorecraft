...
Lorecraft is a fictional website for fans of books set in the Warcraft universe. The Warcraft phenomenon began with the first single-player strategy game developed by Blizzard Entertainment in 1994. The game has gone through many installments, reaching its peak in 2004 when World of Warcraft, a Massively multiplayer online role-playing game, hit store shelves and continues to be developed and played to this day. 
...
Lorecraft application was conceived as a project that creates a safe space to share opinions and popularize lore, present in books and comics that is unknown to many but is set in universe beloved by millions.
...
1. Base Setup
The base setup epic is for all stories needed for the base set up of the application. Without initial steps, development of the application would not be possible, in given conditions and constraints.
1. Prototype
...
1. Deployment
This epic is for deployment related stories. Hosting a site on Heroku, allows users to interact with the application in live environment.
1. Documentation
This epic is for document related stories. It provides essential documentation needed to give an insight into development process and explain all stages of software production cycle. 
...
- As a developer, I need to write README.md so others can check documentation and gain better understanding of application principles
- As a developer, I need to write TESTING.md in order to test application thoroughly and to allow other testers follow the same steps, in testing process
## The-Scope-Plane
...
#### Database design
The database was designed to allow users to perform interact with the application by CRUD principles.  
Book model holds crucial information about each publication, which include :
- cover image 
- authors in relation many-to-many
- genres in relation many-to-many

The review model
Each model has datetimefield to store information about creation of particular content or potential update
...
* Django Class based views (ListView, CreateView, DetailView) - 
* Mixins (LoginRequiredMixin, UserPassesTestMixin) - ensure that 
